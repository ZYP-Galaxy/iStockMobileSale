...
//            url = ip+"/api/DataSync/GetSaleOrdList?userid="+frmlogin.LoginUserid+"&uid="+FilterUser.uid+"&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&ccid="+FilterCustomer.ccid+"&locid="+FilterLocation.locid+"&branid="+FilterBrand.uid+"&language="+frmlogin.Font_Language+ "&entryStatus=2";
            url = "http://" + ip+"/api/DataSync/GetEnqList?userid="+frmlogin.LoginUserid+"&uid="+FilterUser.uid+"&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&ccid="+FilterCustomer.ccid+"&locid="+FilterLocation.locid+"&brandid="+FilterBrand.uid+"&language="+frmlogin.Font_Language+ "&entryStatus=2";
