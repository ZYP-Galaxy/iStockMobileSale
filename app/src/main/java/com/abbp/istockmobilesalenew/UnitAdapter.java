...
public class UnitAdapter extends RecyclerView.Adapter<UnitAdapter.MyViewHolder> {
            ...
            public void onClick(View v) {
                ...
                if (formname == "Sale Order" || formname == "SaleOrder") {
                    ...
                    if (showqty) {
                        ...
                        row_index = position;
                        saleorder_entry.pad = new priceLevelAdapter(context, itemposition, saleorder_entry.txtChangePrice, saleorder_entry.txtChangeQty, saleorder_entry.txtamt, level,"Sale Order");
                    ...
                    switch (price_level) {
                        case "SP":
                            returnin_entry.sd.get(itemposition).setSale_price(data.get(position).getSale_price());
                            returnin_entry.sd.get(itemposition).setDis_price(data.get(position).getSale_price());
                            returnin_entry.sd.get(itemposition).setDis_type(0);
                            level = 0;

                            break;
                        case "SP1":
                            returnin_entry.sd.get(itemposition).setSale_price(data.get(position).getSale_Price1());
                            returnin_entry.sd.get(itemposition).setDis_price(data.get(position).getSale_Price1());
                            returnin_entry.sd.get(itemposition).setDis_type(0);
                            level = 1;
                            break;
                        case "SP2":
                            returnin_entry.sd.get(itemposition).setSale_price(data.get(position).getSale_price2());
                            returnin_entry.sd.get(itemposition).setDis_price(data.get(position).getSale_price2());
                            returnin_entry.sd.get(itemposition).setDis_type(0);
                            level = 2;
                            break;
                        case "SP3":
                            returnin_entry.sd.get(itemposition).setSale_price(data.get(position).getSale_price3());
                            returnin_entry.sd.get(itemposition).setDis_price(data.get(position).getSale_price3());
                            returnin_entry.sd.get(itemposition).setDis_type(0);
                            level = 3;
                            break;
                    }
                    ...
                    if (showqty) {
                        ...
                        returnin_entry.txtshowUnit.setText(data.get(position).getShortdes());
                        txtprice.setText(String.valueOf(returnin_entry.sd.get(itemposition).getSale_price()));
                        double qty = Double.parseDouble(txtunit_qty.getText().toString()) * data.get(position).getSmallest_unit_qty();
                        txtqty.setText(String.valueOf(qty));
                        double amt = Double.parseDouble(txtunit_qty.getText().toString()) * returnin_entry.sd.get(itemposition).getSale_price();
                        txtnet.setText(String.valueOf(amt));
                        btnDiscount.setText("Normal");
                        returnin_entry.txtsmqty.setText(String.valueOf(getsqty(returnin_entry.sd.get(itemposition).getCode(), data.get(position).getUnit_type())));
                        returnin_entry.txtsprice.setText(String.valueOf(getSprice(returnin_entry.sd.get(itemposition).getCode())));
                        returnin_entry.getSummary();
                        row_index = position;
                        returnin_entry.pad = new priceLevelAdapter(context, itemposition, returnin_entry.txtChangePrice, returnin_entry.txtChangeQty, returnin_entry.txtamt, level,"ReturnIn");
                        returnin_entry.rcvSP.setAdapter(returnin_entry.pad);
                        GridLayoutManager gridPricelevel = new GridLayoutManager(context, 4);
                        returnin_entry.rcvSP.setLayoutManager(gridPricelevel);
                        SummaryFormat(txtprice, returnin_entry.sd.get(itemposition).getSale_price());
                        SummaryFormat(txtnet, amt);
                        returnin_entry.uad.notifyDataSetChanged();
                        ...
                        if (cursor != null && cursor.getCount() != 0) {
                            if (cursor.moveToFirst()) {
                                do {
                                    ...
                                    double gallon = returnin_entry.sd.get(itemposition).getUnit_qty() * sqty;
                                    returnin_entry.sd.get(itemposition).setGallon(gallon);
    ...
    public String GetSpecialPriceLevel() {
        ...
        if (formname == "Sale Order" || formname == "SaleOrder") {
            ...
            price_level = returnin_entry.sd.get(itemposition).getPriceLevel();
            long level = 0;
            boolean useUserpricelevel = false;
            boolean useCustpricelevel = false;
            boolean useSpecialPrice = false;
