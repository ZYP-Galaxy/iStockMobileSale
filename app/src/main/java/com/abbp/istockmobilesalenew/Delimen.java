...
public class Delimen implements Serializable {
    private  long Salesmen_Id;
    private String Salesmen_Name;
    private String Salesmen_Short;
    private boolean isChecked = false;
    private long branchid;
    public Delimen(long salesmen_Id, String salesmen_Name, String salesmen_Short) {
        Salesmen_Id = salesmen_Id;
        Salesmen_Name = salesmen_Name;
        Salesmen_Short = salesmen_Short;
    }

    public Delimen(long salesmen_Id, String salesmen_Name, String salesmen_Short, long branchid) {
        Salesmen_Id = salesmen_Id;
        Salesmen_Name = salesmen_Name;
        Salesmen_Short = salesmen_Short;
