...
public class frmsalelist extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setUI() {
        ...
        adp = new saleListAdp(frmsalelist.this, salelists, "Sale");
        rcv.setAdapter(adp);
        ...
        try {
                                ...
                                if (!etdSearch.getText().toString().isEmpty()) {
                                    switch (name) {
                                        case "Customer":
                                            ...
                                            FilterCustomer ca = new FilterCustomer(frmsalelist.this, filteredcustomer, btn, da, "Sale");
                                            rv.setAdapter(ca);
                                        ...
                                        case "User":
                                            ...
                                            FilterUser us = new FilterUser(frmsalelist.this, filtereduser, btn, da, "Sale");
                                            rv.setAdapter(us);
                                        ...
                                        case "Location":
                                            ...
                                            FilterLocation loc = new FilterLocation(frmsalelist.this, filteredloc, btn, da, "Sale");
                                            rv.setAdapter(loc);
            ...
            switch (name) {
                case "Customer":
                    ...
                    FilterCustomer cad = new FilterCustomer(frmsalelist.this, customers, btn, da, "Sale");
                    rv.setAdapter(cad);
                ...
                case "User":
                    ...
                    cursor.close();
                    FilterUser us = new FilterUser(frmsalelist.this, users, btn, da, "Sale");
                    rv.setAdapter(us);
                ...
                case "Location":
                    ...
                    FilterLocation lad = new FilterLocation(frmsalelist.this, locs, btn, da, "Sale");
                    rv.setAdapter(lad);
                ...
                if (cursor != null && cursor.getCount() != 0) {
                    if (cursor.moveToFirst()) {
                        do {
                            ...
                            salelists.add(new salelist(tranid, dateStr, docid, pay_type, currShort, net_amount, usershort, customer_name));
