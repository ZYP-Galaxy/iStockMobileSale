...
//                    cursor = DatabaseHelper.DistinctCategorySelectQuery("Usr_Code",new String[]{"BrandID","BrandName"},"BrandName");
                    cursor=DatabaseHelper.rawQuery("select BrandID,BrandName from Usr_Code where BrandID>0");
    ...
    private  void showStockStatus()
    {
        try {
            ...
            if(Specialfilter=="Code")
            {
                ...
                String search_code=URLEncoder.encode(txtSearchCode.getText().toString(),"UTF-8")
                        .replace("+","%20")
                        .replace("%26","&").replace("%3D","=")
                        .replace("%2C",",");
                url="http://"+ip+"/api/DataSync/CalculateStock?Userid="+frmlogin.LoginUserid+"&Usr_Code="+txtSearchCode.getText().toString()+"&Description=empty"+"&LocID="+FilterLocation.locid+"&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&bchkInactiveStock="+checkedInactive+"&bchkRec="+checkedRdeliver+"&bchkSPorder="+checkedSPOrder+"&category="+FilterCategory.uid+ "&class_id="+FilterClass.uid+"&PlusValue="+PlusValue+"&MinusValue="+MinusValue+"&ZeroValue="+ZeroValue+"&Brand="+FilterBrand.uid;
                /*url="http://"+ip+":"+port+"/api/DataSync/GetData'?Userid="+frmlogin.LoginUserid+"&Usr_Code="+search_code+"&Description=empty"
                        +"&LocID="+FilterLocation.locid+"&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&bchkInactiveStock="+checkedInactive+
                        "&bchkRec="+checkedRdeliver+"&bchkSPorder="+checkedSPOrder+"&category="+FilterCategory.uid+ "&class_id="+FilterClass.uid+
                        "&PlusValue="+PlusValue+"&MinusValue="+MinusValue+"&ZeroValue="+ZeroValue+"&Brand="+FilterBrand.uid;*/
            }
            else  if (Specialfilter=="Description")
            {
                String search_code=URLEncoder.encode(txtSearchCode.getText().toString(),"UTF-8")
                        ...
                        .replace("%26","&").replace("%3D","=")
                        .replace("%2C",",");
                url="http://"+ip+"/api/DataSync/CalculateStock?Userid="+frmlogin.LoginUserid+"&Usr_Code=empty"+"&Description="+txtDescription.getText().toString()+"&LocID="+FilterLocation.locid+"&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&bchkInactiveStock="+checkedInactive+"&bchkRec="+checkedRdeliver+"&bchkSPorder="+checkedSPOrder+"&category="+FilterCategory.uid+ "&class_id="+FilterClass.uid+"&PlusValue="+PlusValue+"&MinusValue="+MinusValue+"&ZeroValue="+ZeroValue+"&Brand="+FilterBrand.uid;
                /*url="http://"+ip+":"+port+"/api/DataSync/GetData'?Userid="+frmlogin.LoginUserid+"&Usr_Code=empty"+
                        "&Description="+search_code+"&LocID="+FilterLocation.locid+
                        "&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&bchkInactiveStock="+checkedInactive+
                        "&bchkRec="+checkedRdeliver+"&bchkSPorder="+checkedSPOrder+"&category="+FilterCategory.uid+
                        "&class_id="+FilterClass.uid+"&PlusValue="+PlusValue+"&MinusValue="+MinusValue+"&ZeroValue="+ZeroValue+"&Brand="+FilterBrand.uid;*/
            }
            else
            {
                url="http://"+ip+"/api/DataSync/CalculateStock?Userid="+frmlogin.LoginUserid+"&Usr_Code=empty"+"&Description=empty"+"&LocID="+FilterLocation.locid+"&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&bchkInactiveStock="+checkedInactive+"&bchkRec="+checkedRdeliver+"&bchkSPorder="+checkedSPOrder+"&category="+FilterCategory.uid+ "&class_id="+FilterClass.uid+"&PlusValue="+PlusValue+"&MinusValue="+MinusValue+"&ZeroValue="+ZeroValue+"&Brand="+FilterBrand.uid;
               /* url="http://"+ip+":"+port+"/api/DataSync/GetData'?Userid="+frmlogin.LoginUserid+"&Usr_Code=empty"+"&Description=empty"
                        +"&LocID="+FilterLocation.locid+"&fdate="+dateFormat.format(fdate)
                        +"&tdate="+dateFormat.format(tdate)+"&bchkInactiveStock="+checkedInactive
                        +"&bchkRec="+checkedRdeliver+"&bchkSPorder="+checkedSPOrder
                        +"&category="+FilterCategory.uid+ "&class_id="+FilterClass.uid+"&PlusValue="+PlusValue
                        +"&MinusValue="+MinusValue+"&ZeroValue="+ZeroValue+"&Brand="+FilterBrand.uid;*/
            }
            ...
            final Response.Listener<String> listener = new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        {
                            jarr= new JSONArray(Rabbit.uni2zg(jarr.toString()));
                        }
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.Description:
                        ...
                        txtSearchCode.setHint("Search Description");
                        txtSearchCode.setText("");
                        return true;
