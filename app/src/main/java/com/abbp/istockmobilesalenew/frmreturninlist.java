...
public class frmreturninlist extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frmreturninlist);
        listcontext = frmreturninlist.this;
        ...
        if (cursor != null && cursor.getCount() != 0) {
            if (cursor.moveToFirst()) {
                do {
                    selectfilter.setText(cursor.getString(cursor.getColumnIndex("Location_Name")));
                    filterV = 3;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.add) {
            Intent intent = new Intent(frmreturninlist.this, sale_entry.class);
    ...
    private void setUI() {
        ...
        pb = new ProgressDialog(frmreturninlist.this, R.style.AlertDialogTheme);
        ...
        findViewById(R.id.imgAdd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(frmreturninlist.this, returnin_entry.class);
                startActivity(intent);
                finish();
        ...
        adp = new saleListAdp(frmreturninlist.this, salelists, "Return In");
        rcv.setAdapter(adp);
        LinearLayoutManager lm = new LinearLayoutManager(frmreturninlist.this, LinearLayoutManager.VERTICAL, false);
        ...
        selectfilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectfilter.getText().toString().trim().equals("Choose Customer") || (filterV == 1 && !selectfilter.getText().toString().trim().equals("Choose User") && !selectfilter.getText().toString().trim().equals("Choose") && !selectfilter.getText().toString().trim().equals("Choose Location") && !selectfilter.getText().toString().trim().equals("Choose Brand"))) {
                    ...
                    AlertDialog.Builder bd = new AlertDialog.Builder(frmreturninlist.this, R.style.AlertDialogTheme);
                    bd.setTitle("iStock");
        ...
        try {
            ...
            imgSearch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        AlertDialog.Builder searchBuilder = new AlertDialog.Builder(frmreturninlist.this, R.style.AlertDialogTheme);
                                ...
                                if (!etdSearch.getText().toString().isEmpty()) {
                                    switch (name) {
                                        case "Customer":
                                            ...
                                            FilterCustomer ca = new FilterCustomer(frmreturninlist.this, filteredcustomer, btn, da, "ReturnIn");
                                            rv.setAdapter(ca);
                                        ...
                                        case "User":
                                            ...
                                            FilterUser us = new FilterUser(frmreturninlist.this, filtereduser, btn, da, "ReturnIn");
                                            rv.setAdapter(us);
                                        ...
                                        case "Location":
                                            ...
                                            FilterLocation loc = new FilterLocation(frmreturninlist.this, filteredloc, btn, da, "ReturnIn");
                                            rv.setAdapter(loc);
            ...
            switch (name) {
                case "Customer":
                    ...
                    FilterCustomer cad = new FilterCustomer(frmreturninlist.this, customers, btn, da, "ReturnIn");
                    rv.setAdapter(cad);
                ...
                case "User":
                    ...
                    cursor.close();
                    FilterUser us = new FilterUser(frmreturninlist.this, users, btn, da, "ReturnIn");
                    rv.setAdapter(us);
                    GridLayoutManager gridLayoutManagerUser = new GridLayoutManager(frmreturninlist.this, 4);
                    rv.setLayoutManager(gridLayoutManagerUser);
                    da.show();
                    break;
                ...
                case "Location":
                    ...
                    FilterLocation lad = new FilterLocation(frmreturninlist.this, locs, btn, da, "ReturnIn");
                    rv.setAdapter(lad);
...
//                        }
                    ...
                    cursor.close();
                    FilterBrand B = new FilterBrand(frmreturninlist.this, brands, btn, da);
                    rv.setAdapter(B);
                    GridLayoutManager gridLayoutManagerUserBrand = new GridLayoutManager(frmreturninlist.this, 4);
    ...
    private void showfiltermenu() {
        ...
        PopupMenu popup = new PopupMenu(frmreturninlist.this, filtermenu);
        ...
        if (frmlogin.UseOffline == 1) {
            ...
            menuitem = popup.getMenu().getItem(3);
            menuitem.setVisible(false);
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(frmreturninlist.this, frmmain.class);
        startActivity(intent);
        finish();
    }
...
//            url = "http://" + ip + ":" + port + "/api/DataSync/GetHeader'?userid=" + frmlogin.LoginUserid + "&uid=" + FilterUser.uid + "&fdate=" + dateFormat.format(fdate) + "&tdate=" + dateFormat.format(tdate) + "&ccid=" + FilterCustomer.ccid + "&locid=" + FilterLocation.locid + "&brandid=" + FilterBrand.uid + "&language=" + frmlogin.Font_Language + "&entryStatus=3";
            url = "http://" +ip+"/api/DataSync/GetEnqList?userid=" + frmlogin.LoginUserid + "&uid=" + FilterUser.uid + "&fdate=" + dateFormat.format(fdate) + "&tdate=" + dateFormat.format(tdate) + "&ccid=" + FilterCustomer.ccid + "&locid=" + FilterLocation.locid + "&brandid=" + FilterBrand.uid + "&language=" + frmlogin.Font_Language + "&entryStatus=3";
    ...
    private void ShowDateFilter() {
        LayoutInflater inflater = (LayoutInflater) frmreturninlist.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View layout = inflater.inflate(R.layout.daterangefilterpopup, null);
        float density = frmreturninlist.this.getResources().getDisplayMetrics().density;
