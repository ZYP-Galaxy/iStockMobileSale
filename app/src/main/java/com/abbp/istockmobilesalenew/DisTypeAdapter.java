        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (formname == "Sale Order") {
                    ...
                    returnin_entry.sd.get(itemposition).setDis_type(data.get(position).dis_type);
                } else {
                            ...
                            try {
                                if (formname == "Sale Order") {
                                    ...
                                    if (keynum.length() > 0) {
                                        if (keynum.contains("%")) {
                                            keynum = keynum.substring(0, keynum.length() - 1);
                                            returnin_entry.dis_percent = Double.parseDouble(keynum);
                                            returnin_entry.dis_typepercent = true;
                                            if (returnin_entry.dis_percent > 99) {
                                                AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.AlertDialogTheme);
                                                builder.setTitle("iStock");
                                                builder.setMessage("Discount Percent should be 0 to 99");
                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        returnin_entry.dis_percent = 0.0;
                                                        btn.setText(String.valueOf(returnin_entry.dis_percent) + "%");
                                                        msg.dismiss();
                                            ...
                                            returnin_entry.disamt = Double.parseDouble(keynum);
                                            returnin_entry.dis_typepercent = true;
                                            returnin_entry.dis_percent = 0;
                                            btn.setText(String.valueOf(returnin_entry.disamt));
                                            returnin_entry.dis_typepercent = false;
                                        }
                                    } else {
