...
public class returnin_entry extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemLongClickListener {
    ...
    public static Button btnpaytype, btncustgroup, btncustomer, btntownship, btnSalesmen, btnCash;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pb = new ProgressDialog(returnin_entry.this, R.style.AlertDialogTheme);
        ...
        imgFilterClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (imgFilterCode.getVisibility()) {
                    ...
                    case View.VISIBLE:
                        usrcodeAdapter usrcodead = new usrcodeAdapter(returnin_entry.this, usr_codes, gridview, categories, "ReturnIn");//added by YLT
...
//                try {
//
//                    AlertDialog.Builder searchBuilder=new AlertDialog.Builder(returnin_entry.this,R.style.AlertDialogTheme);
...
//                        @Override
//                        public void onClick(View v) {
//                            PopupMenu popup = new PopupMenu(returnin_entry.this,btnFilterCode);
...
//        });
        imgFilterCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                s.add("Code");
                s.add("Description");
                ArrayAdapter<String> item = new ArrayAdapter<>(returnin_entry.this, android.R.layout.simple_list_item_1, s);
                lv.setAdapter(item);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(returnin_entry.this, frmreturninlist.class);
                startActivity(i);
...
//Added By abbp barcode scanner on 19/6/2019
        ...
        imgScanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(returnin_entry.this, frmscancode.class);
                startActivity(i);
            }
        });
...
//***************************************************************************************************
    ...
    private void detailvou(String taxper, String total, String txtvou, String vouper, String txtpaidamt, String txttaxam, String txtfocamt, String txtitem) {
        AlertDialog.Builder bd = new AlertDialog.Builder(returnin_entry.this);
...
//        bd.setCancelable(false);
        ...
        view.findViewById(R.id.layoutPaid).setVisibility(View.GONE);
        ...
        txtpaid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isCreditcustomer && sh.get(0).getPay_type() == 2) {
                    ...
                    AlertDialog.Builder ab = new AlertDialog.Builder(returnin_entry.this, R.style.AlertDialogTheme);
                    ab.setTitle("iStock");
                    ab.setMessage("Only Allow in Credit.");
        ...
        switch (fitercode) {
            case "Category":
                ...
                if (frmmain.withoutclass.equals("true")) {
                    ...
                    rrvv = gridview;
                    categoryAdapter ad = new categoryAdapter(returnin_entry.this, filteredList, rrvv, "ReturnIn");//YLT
                    rrvv.setAdapter(ad);
                    GridLayoutManager gridLayoutManager1 = new GridLayoutManager(getApplicationContext(), 4);
                    rrvv.setLayoutManager(gridLayoutManager1);
                } else if (frmmain.withoutclass.equals("false")) {
                    rrvvc = gridclassview;
                    categoryAdapter ad = new categoryAdapter(returnin_entry.this, filteredList, rrvvc, "ReturnIn");//YLT
                    rrvv = gridcodeview;
                    rrvvc.setAdapter(ad);
                    LinearLayoutManager lc = new LinearLayoutManager(returnin_entry.this, LinearLayoutManager.HORIZONTAL, false);
            ...
            case "Code":
                ...
                if (isCategory) {
                    ...
                    if (returnin_entry.usr_codes.size() > 0)
                        if (frmmain.withoutclass.equals("true")) {
                ...
                usrcodeAdapter usrcodead = new usrcodeAdapter(returnin_entry.this, filteredCode, rrvv, categories, "ReturnIn");//added by YLT
            ...
            case "Short":
                ...
                if (isCategory) {
                    ...
                    if (returnin_entry.usr_codes.size() > 0) returnin_entry.usr_codes.clear();
                    if (cursor != null && cursor.getCount() != 0) {
                        if (frmmain.withoutclass.equals("true")) {
                ...
                usrcodeAdapter descad = new usrcodeAdapter(returnin_entry.this, filtereddesc, rrvv, categories, "ReturnIn");//added by YLT
            ...
            case "Class":
                ...
                cad = new classAdapter(returnin_entry.this, filteredclass, gridclassview, "ReturnIn");//added by YLT
                gridclassview.setAdapter(cad);
                LinearLayoutManager classlayoutmanger = new LinearLayoutManager(returnin_entry.this, LinearLayoutManager.HORIZONTAL, false);
...
//                }
                ...
                usrcodeAdapter usrcodeadforBrand = new usrcodeAdapter(returnin_entry.this, filteredbrand, rrvv, "ReturnIn");
    ...
    private void InsertheadMain() {
        ...
        final Response.ErrorListener error = new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(returnin_entry.this, error.getMessage(), Toast.LENGTH_LONG).show();
                pb.dismiss();
            }
        };
    ...
    public static void getData() {
        itemAdapter = new itemAdapter(datacontext, "ReturnIn");//added by YLT
    ...
    private void getHeader() {
        try {
            ...
            String ip = sh_ip.getString("ip", "empty");
            String port = sh_port.getString("port", "empty");
//            url = "http://" + ip + ":" + port + "/api/DataSync/GetHeader?userid=" + frmlogin.LoginUserid + "&order=false";//added by YLT
            url = "http://" + ip + "/api/DataSync/GetNewVoucher?userid=" + frmlogin.LoginUserid + "&entryStatus=3";//added entryStatus to classify sale=1,sale order=2,return in=3
            requestQueue = Volley.newRequestQueue(this);
            final Response.Listener<String> listener = new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
...
//                            double tax_per=getTax();
            ...
            final Response.ErrorListener error = new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    pb.dismiss();
                    AlertDialog.Builder builder = new AlertDialog.Builder(returnin_entry.this);
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog1, int which) {
                            Intent intent = new Intent(returnin_entry.this, frmmain.class);
    ...
    private void BindingClass() {
        ...
        cad = new classAdapter(returnin_entry.this, class_items, gridclassview, "ReturnIn");//added by YLT
        gridclassview.setAdapter(cad);
        LinearLayoutManager classlayoutmanger = new LinearLayoutManager(returnin_entry.this, LinearLayoutManager.HORIZONTAL, false);
        gridclassview.setLayoutManager(classlayoutmanger);
    ...
    private void BindingCategory() {
        ...
        ad = new categoryAdapter(returnin_entry.this, categories, gridview, "ReturnIn");//YLT
    ...
    public void onBackPressed() {
        if (!comfirm && sd.size() > 0) {
            ...
            bd.setTitle("iStock");
            if (sh.get(0).getTranid() > 0) {
                bd.setMessage("Do you Update Voucher?");
            } else
            ...
            bd.setNegativeButton("No", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    intent = new Intent(context, frmreturninlist.class);
                    startActivity(intent);
                    finish();
    ...
    public void GoToSaleList() {
        intent = new Intent(this, frmreturninlist.class);
        startActivity(intent);
        finish();
    }
    ...
    private void ShowPrintSelection() {
        PopupMenu popup = new PopupMenu(returnin_entry.this, imgPrinter);
        //Inflating the Popup using xml file
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (sd.size() > 0) {
                    ...
                    AlertDialog.Builder bd = new AlertDialog.Builder(returnin_entry.this, R.style.AlertDialogTheme);
                    bd.setTitle("iStock");
    ...
    private void showReport(String title) {
        ...
        Intent intent = new Intent(returnin_entry.this, reportviewer.class);
        startActivity(intent);
    }
        ...
        bd.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!comfirm && sd.size() > 0) {
                    ...
                    if (sh.get(0).getTranid() > 0) {
                        conf.setMessage("Do you Update Voucher?");
                    } else
                        conf.setMessage("Do you Confirm Voucher? if you do not comfirm,you lost your data");
                    ...
                    conf.setNegativeButton("N0", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            dialog.dismiss();
                            msg.dismiss();
                            Intent intent = new Intent(returnin_entry.this, frmlogin.class);
                            startActivity(intent);
                            finish();
                        }
                    });
            ...
            imgSearch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        AlertDialog.Builder searchBuilder = new AlertDialog.Builder(returnin_entry.this);
                        View view = getLayoutInflater().inflate(R.layout.searchbox, null);
                        searchBuilder.setView(view);
                        EditText etdSearch = view.findViewById(R.id.etdSearch);
                        ImageButton btnSearch = view.findViewById(R.id.imgOK);
                                ...
                                if (!etdSearch.getText().toString().isEmpty()) {
                                    switch (name) {
                                        case "Customer Group":
                                            ...
                                            CustGroupAdapter ad = new CustGroupAdapter(returnin_entry.this, filteredList, btn, CustomerSetup, "ReturnIn");
                                        ...
                                        case "Township":
                                            ...
                                            TownshipAdapter ta = new TownshipAdapter(returnin_entry.this, filteredtownship, btn, CustomerSetup, "ReturnIn");
                                            rv.setAdapter(ta);
...
//                    }
                    ...
                    CustGroupAdapter ad = new CustGroupAdapter(returnin_entry.this, cg, btn, CustomerSetup, "ReturnIn");
                    CustGroupAdapter.create_customer = true;
                    rv.setAdapter(ad);
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(), 4);
                    rv.setLayoutManager(gridLayoutManager);
...
//                    }
                    ...
                    TownshipAdapter tad = new TownshipAdapter(returnin_entry.this, townships, btn, CustomerSetup, "ReturnIn");
                    rv.setAdapter(tad);
...
//            bd.setCancelable(false);
            ...
            imgClear.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Cursor salemenCursor = DatabaseHelper.rawQuery("select Salesmen_id,Salesmen_Name,short from Salesmen s,Location l where s.branchid=l.branchid and l.locationid=" + returnin_entry.sh.get(0).getLocationid());
                    ...
                    SalesmenAdpater sad = new SalesmenAdpater(returnin_entry.this, salesmen, "ReturnIn");
                    rv.setAdapter(sad);
                    LinearLayoutManager sgridLayoutManager = new LinearLayoutManager(returnin_entry.this, LinearLayoutManager.VERTICAL, false);
                                ...
                                if (!etdSearch.getText().toString().isEmpty()) {
                                    switch (name) {
                                        case "Customer Group":
                                            ...
                                            CustGroupAdapter ad = new CustGroupAdapter(returnin_entry.this, filteredList, btn, da, "ReturnIn");
                                            rv.setAdapter(ad);
                                            GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(), 4);
                                            rv.setLayoutManager(gridLayoutManager);
                                            break;
                                        case "Customer":
                                            ...
                                            CustomerAdapter ca = new CustomerAdapter(returnin_entry.this, filteredcustomer, btn, btnpay, da, "ReturnIn");
                                            rv.setAdapter(ca);
                                        ...
                                        case "Township":
                                            ...
                                            TownshipAdapter ta = new TownshipAdapter(returnin_entry.this, filteredtownship, btn, da, "ReturnIn");
                                            rv.setAdapter(ta);
                                            GridLayoutManager gridLayoutManagertown = new GridLayoutManager(getApplicationContext(), 4);
                                            rv.setLayoutManager(gridLayoutManagertown);
                                            break;
                                        case "Location":
                                            ...
                                            LocationAdapter la = new LocationAdapter(returnin_entry.this, filteredlocation, btn, da, "ReturnIn");
                                            rv.setAdapter(la);
                                        ...
                                        case "Payment Type":
                                            ...
                                            PaymentTypeAdapter pad = new PaymentTypeAdapter(returnin_entry.this, filteredpaytype, btn, da, "ReturnIn");
                                            rv.setAdapter(pad);
                                        ...
                                        case "Salesmen":
                                            ...
                                            sm = new SalesmenAdpater(returnin_entry.this, filteredsalesmen);
                                            rv.setAdapter(sm);
                                            LinearLayoutManager linearLayoutManagerSalesmen = new LinearLayoutManager(returnin_entry.this, LinearLayoutManager.VERTICAL, false);
            ...
            switch (name) {
                ...
                case "Customer Group":
                    ...
                    CustGroupAdapter ad = new CustGroupAdapter(returnin_entry.this, cg, btn, da, "ReturnIn");
                    rv.setAdapter(ad);
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(), 4);
                    rv.setLayoutManager(gridLayoutManager);
                    cursor = null;
                ...
                case "Township":
                    ...
                    TownshipAdapter tad = new TownshipAdapter(returnin_entry.this, townships, btn, da, "ReturnIn");
                    rv.setAdapter(tad);
                    GridLayoutManager gridLayoutManagerTownship = new GridLayoutManager(getApplicationContext(), 4);
                    rv.setLayoutManager(gridLayoutManagerTownship);
                    da.show();
                ...
                case "Customer":
                    ...
                    CustomerAdapter cad = new CustomerAdapter(returnin_entry.this, customers, btn, btnpay, da, "ReturnIn");
                    rv.setAdapter(cad);
                ...
                case "Location":
                    ...
                    LocationAdapter lad = new LocationAdapter(returnin_entry.this, locations, btn, da, "ReturnIn");
                    rv.setAdapter(lad);
                ...
                case "Payment Type":
                    ...
                    PaymentTypeAdapter pad = new PaymentTypeAdapter(returnin_entry.this, pay_types, btn, da, "ReturnIn");
                    rv.setAdapter(pad);
                    GridLayoutManager gridLayoutManagerPaymentType = new GridLayoutManager(getApplicationContext(), 4);
                    rv.setLayoutManager(gridLayoutManagerPaymentType);
                    da.show();
    ...
    private void Add_Customer() {
        selected_townshipid = 1;
        selected_custgroupid = 1;
        AlertDialog.Builder addcustomer = new AlertDialog.Builder(returnin_entry.this);
...
//                        "values("+Customer_Code+","+Customer_Name+","+selected_townshipid+","+isCredit+","+selected_custgroupid+",1,0,"+frmlogin.LoginUserid+")";
                if (etdCustomerName.getText().toString().trim().isEmpty() && etdCustomerCode.getText().toString().trim().isEmpty()) {
                    ...
                    Toast.makeText(returnin_entry.this, "Please set Cutomer Name and Code", Toast.LENGTH_LONG).show();
                    return;
                } else {
    ...
    public static void getSummary() {
        ...
        foc_tmp = 0.0;
        if (sd.size() > 0) {
            for (int i = 0; i < returnin_entry.sd.size(); i++) {
                totalAmt_tmp += returnin_entry.sd.get(i).getUnit_qty() * returnin_entry.sd.get(i).getSale_price();
                qty_tmp += sd.get(i).getUnit_qty();
                if (sd.get(i).getDis_type() == 1 || sd.get(i).getDis_type() == 2 || sd.get(i).getDis_type()
                        == 5) {
                    itemDis_tmp += (sd.get(i).getSale_price() - sd.get(i).getDis_price()) * returnin_entry.sd.get(i).getUnit_qty();
                    ...
                    foc_tmp += sd.get(i).getSale_price() * returnin_entry.sd.get(i).getUnit_qty();
    ...
    private void showKeyPad(TextView txt, TextView source) {
        ...
        startOpen = true;
        LayoutInflater inflater = (LayoutInflater) returnin_entry.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View layout = inflater.inflate(R.layout.keypad, null);
        float density = returnin_entry.this.getResources().getDisplayMetrics().density;
...
//msg box and condition for voudisAmt modified by ABBP
                        ...
                        if (voudis) {
                            if (check > net_amount) {
                                ...
                                sh.get(0).setDiscount(0);
                                txtvoudis.setText("0");
                                new AlertDialog.Builder(returnin_entry.this, R.style.AlertDialogTheme)
                                        .setTitle("iStock")
    ...
    private void Confirm() {
        String ip = sh_ip.getString("ip", "empty");
        String port = sh_port.getString("port", "empty");
//        String sqlUrl = "http://" + ip + ":" + port + "/api/DataSync/SaveData?" + "order=returnin";//added by YLT
        String sqlUrl = "http://" + ip + "/api/DataSync/SaveData?entryStatus=3";//added entryStatus to classify sale=1,sale order=2,return in=3
        sqlstring = sqlstring + "&" + sh.get(0).getTranid() + "&" + paid + "&" + changeamount;
//        new SaveData().execute(sqlUrl);
        SaveVoucher(sqlUrl, sqlstring);
    }

    //Added by KLM 23022022
    private void SaveVoucher(String url, String requestBody) {
        ProgressDialog progressDialog = new ProgressDialog(returnin_entry.this, R.style.AlertDialogTheme);
...
//                        String[] value = response.split("&");
                        ConfirmedTranid = Long.parseLong(response);
//                        docid = value[1];
                    }
                    ...
                    if (ConfirmedTranid > 0) {
                        ...
                        if (ConfirmedTranid - sh.get(0).getTranid() == 0) {
                            builder.setMessage("Updating Successfully");
                        }
                    } else {
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(returnin_entry.this, R.style.AlertDialogTheme);
            ...
            Toast.makeText(returnin_entry.this, "Error occur while saving!\n" + ex.getMessage(), Toast.LENGTH_LONG).show();
...
//        String sqlUrl = "http://" + ip + ":" + port + "/api/DataSync/SaveData?userid=" + frmlogin.LoginUserid + "&language=" + frmlogin.Font_Language + "&allcustomer=" + allcustomer;
    ...
    private void PrintVoucher(long tranid) {
        ...
        if (frmlogin.Confirm_PrintVou == 1 && bill_not_print == false && billprintcount > 0 && ConfirmedTranid > 0) {
            ...
            sqlUrl = "http://" + ip + "/api/DataSync/GetData?" + sqlstring;
            requestQueue = Volley.newRequestQueue(this);
            final Response.Listener<String> listener = new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    ...
                    try {
                        AlertDialog.Builder b = new AlertDialog.Builder(returnin_entry.this);
                        b.setTitle("iStock");
                        ...
                        b.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (sd.size() > 0) sd.clear();
                                if (comfirm) {
                                    intent = new Intent(returnin_entry.this, returnin_entry.class);
                                    finish();
                                    startActivity(intent);
                                } else if (logout) {
                                    ...
                                    intent = new Intent(getApplicationContext(), frmreturninlist.class);
                                    startActivity(intent);
                                    finish();
                                }
                            }
            ...
            long flagVariable = 0;
            if (ConfirmedTranid - sh.get(0).getTranid() != 0) {
                flagVariable = ConfirmedTranid - sh.get(0).getTranid();
                if (sh.size() > 0) sh.clear();
                if (sd.size() > 0) sd.clear();
    ...
    private void updateVoucher() {
        ...
        try {
            if (tranid < 0 || sh.get(0).getTranid() > 0) {
...
//                }
                ...
                String head = "update Returnin_Head_Main set\n" +
    ...
    public void EditInfo() {
        if (itemPosition > -1 && sd.size() > 0) {
            ...
            if (use_multipricelvl) {
                ...
                pad = new priceLevelAdapter(returnin_entry.this, itemPosition, txtChangePrice, txtChangeQty, txtamt, row_index, "ReturnIn");
...
//Added by abbp default unit type on 09/7/2019
                ...
                uad = new UnitAdapter(returnin_entry.this, unitforcodes, itemPosition, txtChangePrice, txtsqty, txtChangeQty, txtamt, btndiscount, row_index, "ReturnIn");
            ...
            btndiscount.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        DisTypeAdapter ad = new DisTypeAdapter(returnin_entry.this, cg, btndiscount, disDa, itemPosition, txtChangeQty, "ReturnIn");
                        rv.setAdapter(ad);
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(), 4);
                        rv.setLayoutManager(gridLayoutManager);
                        cursor = null;
            ...
            save.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sd.get(itemPosition).getDis_type() == 3
                        ...
                        if (dis_typepercent) {
                            double dis_percent = returnin_entry.dis_percent;
                    ...
                    entrygrid.setAdapter(itemAdapter);
                    returnin_entry.entrygrid.setSelection(itemPosition);
                    getSummary();
                    dialog.dismiss();
                }
            });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.viewDelAll:
                ...
                if (sd.size() > 0) {
                    ...
                    bd.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            sd.clear();
                            itemAdapter = new itemAdapter(returnin_entry.this, "ReturnIn");//added by YLT
                            entrygrid.setAdapter(itemAdapter);
                            String tax = "Tax" + (getTax() > 0 ? "( " + getTax() + "% )" : "");
                            txttax.setText(tax);
                            txtfoc.setText("0.00");
            ...
            case R.id.imgLogout:
                ...
                LogOut();
                break;
            //added by KLM for Code find 17022022
...
//                Toast.makeText(getApplicationContext(), "u toast me", Toast.LENGTH_SHORT).show();
                GetRefID();
...
//                builder.setCancelable(false);
                ...
                TextView cashInOut = view.findViewById(R.id.cashid);
                cashInOut.setText("Cash Out");
...
//not change_date in sale entry txtdate modified by ABBP
    ...
    private void CodeFind() {
        AlertDialog.Builder searchBuilder = new AlertDialog.Builder(datacontext, R.style.AlertDialogTheme);
        ...
        CodeFindListViewAdapter codeFindListViewAdapter = new CodeFindListViewAdapter(datacontext, R.layout.codefinditemlist, codes);
        ...
        txtcodeSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int start, int before, int count) {
                ...
                CodeFindListViewAdapter codeFindListViewAdapter = new CodeFindListViewAdapter(datacontext, R.layout.codefinditemlist, tmpCodes/*,formname*/);
                codefindListView.setAdapter(codeFindListViewAdapter);
        ...
        codefindListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                usrcodeAdapter.formname = "ReturnIn";
                int defunit = 1;
                defunit = frmmain.defunit;
                int[] ut = new int[3];
                int i = 0;
                ...
                if (i > 1) {
                    ...
                    if (i == 3) {
                        ...
                        cursor.close();
                        itemAdapter.notifyDataSetChanged();
                        entrygrid.setSelection(returnin_entry.sd.size());
                        getSummary();
                    } else {
                        int utt = 2;
                        ...
                        String sale_price = specialPrice == 0 ? "uc.sale_price" : "uc.sale_price" + specialPrice;
                        String SP = specialPrice == 0 ? "SP" : "SP" + specialPrice;
                        String sqlString = "select uc.salecurr,uc.unit_type,code,description," + sale_price + ",open_price,smallest_unit_qty,unitname,unitshort,CalNoTax from Usr_Code uc " +
    ...
    private void GetRefDocid(ListView lst) {
        ...
        try {
            ...
            String ip = sh_ip.getString("ip", "empty");
            String port = sh_port.getString("port", "empty");
//            url = "http://" + ip + ":" + port + "/api/DataSync/RefDocidSource?customerid=" + sh.get(0).getCustomerid() + "&tranid=" + sh.get(0).getTranid() + "&date=" + sh.get(0).getDate() + "&isreturn=true";
            url = "http://" + ip + "/api/DataSync/RefDocidSource?customerid=" + sh.get(0).getCustomerid() + "&tranid=" + sh.get(0).getTranid() + "&date=" + sh.get(0).getDate() + "&isreturnin=true";
            requestQueue = Volley.newRequestQueue(this);
            final Response.Listener<String> listener = new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        RefDociAdapter ref = new RefDociAdapter(returnin_entry.this, refDocids);
                        lst.setAdapter(ref);
    ...
    private void FillVoucher(String refdocid) {
        ...
        try {
            ...
            String ip = sh_ip.getString("ip", "empty");
            String port = sh_port.getString("port", "empty");
            url = "http://" + ip + "/api/DataSync/RefReturnInItemList?userid=" + frmlogin.LoginUserid + "&EditTranid=" + sh.get(0).getTranid() +
                    ...
                    try {
                        if (response != "empty") {
                            ...
                            for (int count = 0; count < sale.length(); count++) {
                                ...
                                String sqlString = "";
                                //customer group
                                if (!unit_short.equals("") && !unit_short.equals("0")) {
...
//                                so_heads.add(new so_head(ref_tranid, pay_type, discount, Double.parseDouble(discount_per)));
                        ...
                        System.out.println(ee + " this is error");
                    }
                }
    ...
    private void ShowOrderList() {
        ...
        caption.setText("Sale Code Lists");
        ImageView imgSave = view.findViewById(R.id.imgSave);
        ...
        OrderCodeAdapter ord = new OrderCodeAdapter(returnin_entry.this, so_dets);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (msg.equals("Addding New Customer is Fail!!")) {
                    AlertDialog.Builder b = new AlertDialog.Builder(returnin_entry.this, R.style.AlertDialogTheme);
                    b.setTitle("iStock");
                    if (allcustomer) {
            ...
            if (cursor != null && cursor.getCount() != 0) {
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        returnin_entry.sd.get(position).setSale_price(sale_price);
                        returnin_entry.sd.get(position).setPriceLevel(price_level);
                ...
                level = 0;
                returnin_entry.sd.get(position).setSale_price(getSalePrice("SP", position));
                returnin_entry.sd.get(position).setPriceLevel("SP");
    ...
    private double getSalePrice(String pricelevel, int itemposistion) {
        ...
        String sqlString = "select uc.sale_curr,uc.unit_type,code,description," + level + ",smallest_unit_qty,unitname,unitshort,CalNoTax from Usr_Code uc " +
                " where code=" + returnin_entry.sd.get(itemposistion).getCode() + " and unit_type=" + editUnit_type;
        Cursor cursor = DatabaseHelper.rawQuery(sqlString);
        if (cursor != null && cursor.getCount() != 0) {
            if (cursor.moveToFirst()) {
                do {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (ConfirmedTranid > 0) {
                    ...
                    ConfirmedTranid = Long.parseLong(s);
                    if (ConfirmedTranid - sh.get(0).getTranid() == 0) {
                        b.setMessage("Updating Successfully");
                    }
                } else {
