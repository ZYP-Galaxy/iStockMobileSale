...
public class so_det {
    ...
    public so_det(double unit_qty, int unit_type, double price, double dis_price, long dis_type, double discount, long code, String unit_short, String desc, String pricelevel, long so_id, int so_sr,String usr_code,String remark) {
        this.unit_qty = unit_qty;
        this.unit_type = unit_type;
        this.price = price;
        this.dis_price = dis_price;
